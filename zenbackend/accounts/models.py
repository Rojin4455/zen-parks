...
class Opportunity(models.Model):
    ...
    sq_ft = models.CharField(max_length=50, default="No Data")
...
class Contact(models.Model):
    ...
    first_name = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    last_name = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    business_name = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    company_name = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    phone = models.CharField(max_length=20, blank=True, null=True, default="No Data")
    email = models.EmailField(blank=True, null=True, default="No Data")
    created = models.DateTimeField(blank=True, null=True)
    tags = models.TextField(blank=True, null=True, default="No Data")
    utm_source = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    utm_medium = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    utm_campaign = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    utm_content = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    utm_term = models.CharField(max_length=255, blank=True, null=True, default="No Data")
    utm_traffic_type = models.CharField(max_length=255, blank=True, null=True, default="No Data")
